...
## Hash Functions
As compared to encryption functions, hash functions are one-way functions, keyless and serve to validate the integrity of data. As such, hashes are
a representation of digital signatures. On a high level, this is how we could use hashing:

1. Write our message to a file
2. Use the SHA256 algorithm to hash the message
