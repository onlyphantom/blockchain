...
We allude to the idea of "blocks" but we haven't got to an official definition of what constitutes a block. This is what the following section does.
...
In summary, Merkle trees offer the following advantages:
...
uses the Merkle root included in each block header rather than the full transaction logs itself.
    - This is a concept known as Simplified Payment Verification (SPV), described in section 8 (titled "SPV") of the Bitcoin whitepaper. It refers to the ability 
