...
### Comparison to SHA-256 and SHA-3 (Keccak)
...
In recent years, SHA-256 has been adopted by many cryptographic protocols, including TLS and SSL (replacing SHA-1) and it's also used by the Bitcoin protocol.
